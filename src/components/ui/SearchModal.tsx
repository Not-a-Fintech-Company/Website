...
export default function SearchModal() {
  ...
  // Pagefind is generated by a post-build step; the file does not exist during `astro dev`.
  // Assigning to a variable defeats Vite's static import-analysis (which @vite-ignore alone
  // does NOT suppress for absolute URL paths). The .catch handles the dev 404 silently.
  useEffect(() => {
    if (!open) return;
