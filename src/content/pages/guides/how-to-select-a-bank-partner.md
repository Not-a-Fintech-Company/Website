...
These are a handful of dimensions to look at when choosing a bank partner to launch a new product:
...
Some pricing will be dependent on the amount of deposits originated for the bank, where the bank actually pays you to originate deposits for them, and charges you nothing else, but those are rare and require a product with minimal operational overhead for the bank.
