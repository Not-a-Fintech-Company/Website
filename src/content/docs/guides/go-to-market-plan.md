...
### Other Notes
* It's ok to pick the wrong product to start! Chris Britt at Chime started with a rewards product and then pivoted into the 2 day early deposit product, but if you don't have a product, you can't get to the next downstream decision
...
### Deliverables
* Have signed agreements with banking providers and other vendors - make sure you have 1) issuing bank 2) card network 3) processor 4) card provider - much of this can be done by a BaaS provider to start
* Have working mobile app
* If building a credit product, have an underwriting / credit lead ready to hire
...
### Other Notes
   * Product marketing fit (finding scalable and durable marketing channels) is just as hard to find as product market fit in Fintech. You might have the right product for your segment, but if they never know you exist, it doesn't matter
...
### What do people get wrong at this stage?
   ...
   * Launching with influencers too early - make sure the beta is complete first. Feedback is critical - you want to know how people are using the product and what works and what doesn't before going out with a bang. Think about influencers as a way to *accelerate* growth, not launch for the first time
